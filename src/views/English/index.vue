...
export default {
  ...
  methods: {
    ...
    chapter() {
      this.$router.push('/english-chapter');
    },
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          已选：
          <div class="english-list__select">
            <div
              v-for="(item,index) in selectLanguage"
              :key="index"
              class="english-list__sec">
              {{ item.name }}
